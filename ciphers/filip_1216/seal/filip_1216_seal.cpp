...
void FiLIP_1216_SEAL::encrypt_key() {
...
std::vector<Ciphertext> FiLIP_1216_SEAL::HE_decrypt(
...
std::vector<uint8_t> FiLIP_1216_SEAL::decrypt_result(
...
void FiLIP_1216_SEAL::FLIP(std::vector<seal::Ciphertext>& state,
                           seal::Ciphertext& out) {
  size_t nb = 0;
...
void FiLIP_1216_SEAL::treeMul(std::vector<seal::Ciphertext>& tree) {
  auto len = tree.size();
