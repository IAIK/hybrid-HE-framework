...
using namespace DASTA_6_PACKED;

// build an array of KnownAnswerTests for DASTA_128
KnownAnswerTest<DASTA_128> KNOWN_ANSWER_TESTS[] = {
    {
        ...
        KnownAnswerTest<DASTA_128>::Testcase::DEC,
    },
    {
        {0x76, 0xad, 0x7b, 0x3f, 0x23, 0xe9, 0x58, 0x09, 0x47, 0x7c, 0xb8,
         0x14, 0xcc, 0x35, 0xec, 0x1e, 0xa6, 0x1e, 0xba, 0xfe, 0x80, 0x43,
        ...
        {0x00},
        {0x00},
        KnownAnswerTest<DASTA_128>::Testcase::USE_CASE,
        5,
        16,
    },
    {
        ...
        {0x00},
        {0x00},
        KnownAnswerTest<DASTA_128>::Testcase::PREP,
    }};
