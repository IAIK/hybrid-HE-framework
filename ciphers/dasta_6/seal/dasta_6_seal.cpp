...
void DASTA_128_SEAL::encrypt_key() {
...
std::vector<Ciphertext> DASTA_128_SEAL::HE_decrypt(
...
std::vector<uint8_t> DASTA_128_SEAL::decrypt_result(
...
void DASTA_128_SEAL::MultiplyPermutedWithGF2Matrix(
...
void DASTA_128_SEAL::MultiplyWithGF2Matrix(const mzd_t* matrix,
                                           std::vector<Ciphertext>& state) {
...
void DASTA_128_SEAL::add(std::vector<Ciphertext>& state,
...
void DASTA_128_SEAL::sboxlayer(std::vector<Ciphertext>& state) {
  std::vector<Ciphertext> out;
