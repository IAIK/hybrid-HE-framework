...
void FiLIP_1280_HElib::encrypt_key() {
...
std::vector<Ctxt> FiLIP_1280_HElib::HE_decrypt(
...
std::vector<uint8_t> FiLIP_1280_HElib::decrypt_result(
...
void FiLIP_1280_HElib::FLIP(std::vector<Ctxt>& state, Ctxt& out) {
  size_t nb = 0;
...
void FiLIP_1280_HElib::treeMul(std::vector<helib::Ctxt>& tree) {
  auto len = tree.size();
