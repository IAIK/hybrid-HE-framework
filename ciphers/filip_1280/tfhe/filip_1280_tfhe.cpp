...
void FiLIP_1280_TFHE::encrypt_key() {
...
TFHECiphertextVec FiLIP_1280_TFHE::HE_decrypt(std::vector<uint8_t>& ciphertexts,
                                              size_t bits) {
...
std::vector<uint8_t> FiLIP_1280_TFHE::decrypt_result(
...
void FiLIP_1280_TFHE::FLIP(TFHECiphertextVec& state, LweSample& out) {
  size_t nb = 0;
