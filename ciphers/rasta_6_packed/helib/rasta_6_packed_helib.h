...
#include "../plain/rasta_6_packed_plain.h"  // for RASTA_128_params
...
class RASTA_128_HElib : public HElibCipher {
 public:
  ...
  virtual std::string get_cipher_name() const {
    return "RASTA-PACKED-HElib (n=351,r=6)";
  }
 ...
 private:
  static constexpr uint64_t BSGS_N1 = 27;
  static constexpr uint64_t BSGS_N2 = 13;
